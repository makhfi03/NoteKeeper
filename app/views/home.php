    ...
    <section id="hero" class="min-h-[calc(100vh-140px)] flex flex-col items-center justify-center relative overflow-hidden px-6 py-20">
        ...
        <div class="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <div class="hero-fade hero-fade-3 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="/register" id="btn-register" class="btn-primary w-full sm:w-auto px-10 py-4 text-sm font-semibold tracking-wide uppercase text-cream-50 bg-coffee-700 rounded-full shadow-xl shadow-coffee-700/20 transition-all duration-500 flex items-center justify-center gap-2.5">
                ...
                <a href="/login" id="btn-login" class="btn-secondary w-full sm:w-auto px-10 py-4 text-sm font-semibold tracking-wide uppercase text-coffee-600 border-2 border-coffee-300 rounded-full transition-all duration-500 flex items-center justify-center gap-2.5">
