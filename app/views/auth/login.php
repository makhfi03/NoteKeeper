    ...
    <div class="relative z-10 w-full max-w-md px-6">
        ...
        <div class="bg-cream-50 p-8 rounded-3xl shadow-xl shadow-coffee-900/5 border border-cream-200 hero-fade hero-fade-2">
            ...
            <p class="text-center text-sm text-coffee-500 mt-6">
                    Pas encore de compte ? <a href="index.php?page=register" class="font-medium text-coffee-700 hover:text-coffee-900 underline underline-offset-4 transition-colors">S'inscrire</a>
            </p>
        </div>
    </div>
</body>
