    <div id="editNoteModal" class="fixed inset-0 z-50 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-300">
        ...
        <div class="bg-cream-50 w-full max-w-xl rounded-[2rem] shadow-2xl relative z-10 transform scale-95 transition-transform duration-300 border border-cream-200 flex flex-col max-h-[90vh]" id="editModalContent">
            ...
            <div class="p-8 overflow-y-auto">
                <form action="/notes/edit" method="POST" class="space-y-6">
                    <input type="hidden" id="edit_id" name="id" value="">
                    <div>
                        <label for="edit_titre" class="block text-sm font-medium text-coffee-800 mb-2">Titre de la note</label>
                        <input type="text" id="edit_titre" name="title" class="w-full px-5 py-3.5 rounded-xl bg-white border border-cream-300 focus:border-coffee-400 focus:ring-2 focus:ring-coffee-400/20 outline-none transition-all text-coffee-900 placeholder-coffee-300 shadow-sm" required>
                    </div>

                    <div>
                        <label for="edit_contenu" class="block text-sm font-medium text-coffee-800 mb-2">Contenu</label>
                        <textarea id="edit_contenu" name="content" rows="8" class="w-full px-5 py-3.5 rounded-xl bg-white border border-cream-300 focus:border-coffee-400 focus:ring-2 focus:ring-coffee-400/20 outline-none transition-all text-coffee-900 placeholder-coffee-300 resize-none shadow-sm" required></textarea>
                    </div>
